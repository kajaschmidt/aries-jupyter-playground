...
class BaseController:
    ...
    async def admin_request(
        ...
        print("admin_request", method, "to", path)
        print("json:", json_data, "params:", params, "data:", data)
    ...
    async def admin_POST(
        ...
        try:
            ...
            print("Controller POST %s request to Agent%s", path, (" with data: \n{}".format(repr_json(json_data)) if json_data else ""),) #@todo clean up

            response = await self.admin_request("POST", path, json_data, text, params, data)

            print("Response from POST %s received: \n%s", path, repr_json(response)) #@todo clean up
